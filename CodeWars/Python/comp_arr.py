...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  6 22:47:30 2022
...
def comp(array1, array2):
    if (array1 == None) | (array2 == None):
        return False
    #in case it wasn't specified that arrays will have the same length:
    #elif (len(array1) != len(array2)):
    #    return False
    else:
         return True if sorted([a ** 2 for a in array1]) == sorted(array2) else False 
