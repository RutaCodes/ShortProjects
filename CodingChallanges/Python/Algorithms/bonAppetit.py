...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 26 22:26:27 2023
...
correctly, Anna will pay (2+4)/2 = 3. If he includes the cost of bill[2], he will 
calculate (2+4+6)/2 = 6. In the second case, he should refund 3 to Anna.

Function should print Bon Appetit if the bill is fairly split. Otherwise, 
